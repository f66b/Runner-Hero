...
public class Script {
    ...
    public void play() {
        try {
            ...
            while ((line = reader.readLine()) != null && !line.trim().isEmpty()) {
                ...
                if (line.equals("done")) {
                    out.println("OK: Script completed successfully");
                    break;
                }
    ...
    private void handlePlay(String params) {
        ...
        out.println("Starting new game with word: " + words[wordIndex]);
    }
    
    private void handleGuess(char letter) {
        hangedMan.play(letter);
        out.println("Guessed '" + letter + "': " + hangedMan.guessed() + " (Tries left: " + hangedMan.getRemainingTries() + ")");
    }
    ...
    private void verifyLoss() {
        ...
        out.println("OK: Game lost as expected");
    }
